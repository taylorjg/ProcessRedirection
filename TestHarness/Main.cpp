...
static void RunProcessWithRedirectionAsync_WhenItCallsRunProcessAndWaitTwice_Succeeds (void);
...
int main ()
{
	...
	RunProcessWithRedirectionAsync_WhenItCallsRunProcessAndWaitTwice_Succeeds ();
...
//*****************************************************************************
//* Function Name: RunProcessWithRedirectionAsync_WhenItCallsRunProcessAndWaitTwice_Succeeds
//*   Description: 
//*****************************************************************************
static void RunProcessWithRedirectionAsync_WhenItCallsRunProcessAndWaitTwice_Succeeds (void)
{
	(void) _tprintf (_T("RunProcessWithRedirectionAsync_WhenItCallsRunProcessAndWaitTwice_Succeeds\n"));

	CRunProcessWithRedirectionAsync l_SUT;

	// First call.
	DWORD l_dwResult = l_SUT.RunProcessAndWait (CombineWithSystemDirectory (_T("cmd.exe")), _T("/c dir /b %SystemDrive%\\"));
	...
	// Second call.
	l_dwResult = l_SUT.RunProcessAndWait (CombineWithSystemDirectory (_T("ipconfig.exe")));
